...
<body>
    <main>
        ...
        <div class="registration-form">
            <h1 class="form-title">APERTURA DE EXPEDIENTE</h1>
            <p class="form-description">
                La apertura de expedientes es el punto de partida para la gestión ordenada y eficiente de cualquier
                proceso, garantizando transparencia, seguimiento y control documental desde el primer momento.
            </p>

            <div class="form-section">
                <div class="form-row">
                    <div class="form-group">
                        <label for="numero_exp">numero de expediente:</label>
                        <input type="text" id="numero_exp" name="numero_exp">
                    </div>

                    <div class="form-group">
                        <label for="rep_legal">nombre y apellido:</label>
                        <input type="text" id="rep_legal" name="rep_legal">
                    </div>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="ced_rif">cedula o rif:</label>
                        <input type="text" id="ced_rif" name="ced_rif">
                    </div>
                    <div class="form-group">
                        <label for="ubicacion">direccion:</label>
                        <input type="tel" id="ubicacion" name="ubicacion">
                    </div>
                    <div class="form-group dates">
                        <label for="ubicacion">fecha de apertura</label>
                        <input type="date" id="ubicacion" name="ubicacion">
